  ...
  return (
    <div className="w-full flex flex-col gap-3">
      ...
      <button
        ...
        disabled={loading}
        className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-2xl bg-surface border border-outline/20 hover:bg-surface-variant transition-colors disabled:opacity-50"
      >
